...
public class Profile extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        notificationSpinner = findViewById(R.id.spinner1);
        alarmToneSpinner = findViewById(R.id.spinner2);
        wakeUpTimeSpinner = findViewById(R.id.spinner3);
        languageSpinner = findViewById(R.id.spinner4);
        bedTimeSpinner = findViewById(R.id.spinner5);
