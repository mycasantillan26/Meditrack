...
public class EditPlan extends AppCompatActivity {
    ...
    private void updatePlanDetails() {
        ...
        updatedData.put("startDate", startDateSpinner.getText().toString());  // Changed to getText()
        updatedData.put("endDate", endDateSpinner.getText().toString());      // Changed to getText()
