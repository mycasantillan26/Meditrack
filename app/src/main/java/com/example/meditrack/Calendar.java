    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        profileButton.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                Intent intent = new Intent(Calendar.this, Profile.class); // Replace Profile.class with your actual Profile activity class
        ...
        todayIcon.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                Intent intent = new Intent(Calendar.this, Today.class);
        ...
        imgIcon.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                // Start the Calendar activity when the calendar icon is clicked
                Intent intent = new Intent(Calendar.this, Plans.class);
                intent.addFlags(Intent.FLAG_ACTIVITY_NO_ANIMATION);
                startActivity(intent);
            }
        });
        ...
        trackerIcon.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                // Start the Calendar activity when the calendar icon is clicked
                Intent intent = new Intent(Calendar.this, TrackSymptoms.class);
                intent.addFlags(Intent.FLAG_ACTIVITY_NO_ANIMATION);
                startActivity(intent);
            }
        });
